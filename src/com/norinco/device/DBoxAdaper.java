...
public class DBoxAdaper extends SimpleCursorAdapter{
	private LayoutInflater inflater;
	int nCount ;
	
	Map<Integer, Boolean> map = new HashMap<Integer, Boolean>();
	
	public DBoxAdaper(Context context, int layout, Cursor cursor, String[] from,int[] to) {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		String id = cursor.getString(cursor.getColumnIndex("factory"));
		String name = cursor.getString(cursor.getColumnIndex("devname"));
		String level = cursor.getString(cursor.getColumnIndex("number"));
