...
//	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mButtonFault = (Button)findViewById(R.id.delete);
	...
	private class CheckBoxListener implements OnCheckedChangeListener {
		...
		public void onCheckedChanged(CompoundButton buttonView,
			...
			if (isChecked) {
				...
				Toast.makeText(function_Activity.this, buttonView.getText() + "被选择",
						Toast.LENGTH_SHORT).show();
			} else {
				DeleteData(buttonView.getText().toString());
				Toast.makeText(function_Activity.this, buttonView.getText() + "取消选择",
						Toast.LENGTH_SHORT).show();
			}
		}
	...
	private class myOnClickListener implements Button.OnClickListener {
		...
		public void onClick(View v) {
			if (v == mButton01) {
				...
				intent.setClass(function_Activity.this, DetailsActivity.class);
